...
pub use storage::{
    ...
    EntityStore, ReconcileAction,
};

// Re-export index entry schema types at the crate root for convenient access.
pub use discovery::{
    DiscoveredStore, IntegrationStatus, ReconcileSummary, STORE_MARKERS,
...
pub use model::{
    ...
    index_sidecar::{
        IndexSidecar, SidecarError, SidecarValidationIssue, read_sidecar,
        write_sidecar,
    },
